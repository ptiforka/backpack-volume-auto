...
DELAY_BETWEEN_DEAL = (1, 2)  # Execute delay between full trade (Buy -> Sell -> Delay -> Buy -> Sell -> Delay ...)

NEEDED_TRADE_VOLUME = 100_000  # volume to trade, if 0 it will never stop
...
ALLOWED_ASSETS = ["SOL_USDC", "JUP_USDC", "BTC_USDC"]
